...
// }
// // let arr = [1, 2, 3, 4, 5];
// // let middleElements = getMiddleElements(arr);
// // console.log(middleElements);

// console.log("Problem2");
// // console.log(getMiddleElements(arr));
...
console.log(getMiddleElements([1, 2, 3, 4, 5])); // Output: [3]
console.log(getMiddleElements([1, 2, 3, 4])); // Output: [2, 3]
